  ...
  return (
    <div className="flex flex-col w-full lg:w-4/5 m-auto md:mt-10 px-7 py-5 bg-gray-750 text-gray-300 min-h-screen">
      ...
      <div className="text-sm lg:text-base mt-4 ">
        <div className="flex items-center justify-between bg-gray-light px-2 py-2 w-full md:w-80 text-gray-400 focus-within:text-gray-200">
          <div className="flex items-center">
            ...
            <input
              ...
              value={search}
              className="outline-none  w-full border-none bg-transparent px-1 pl-2 py-1 focus:ring-0"
              onChange={(e) => {
          ...
          {search !== "" ? (
            <XIcon
              className="h-5 text-current cursor-pointer"
              onClick={() => setSearch("")}
            />
          ) : (
            ""
